package cn.xueden.common.security.aspect;
 ...
 * @Auther:梁志杰
 * @Date:2020/9/24
 * @Description:cn.xueden.common.security.aspect
 * @version:1.0
 */
@Aspect
@Component
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(cn.xueden.common.security.annotation.PreAuthorize)")
