...
@Order(5)
@Component
public class OtherWebLogAspect {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OtherWebLogAspect.class);

    @Pointcut("@annotation(cn.xueden.common.log.annotation.XudenOtherSystemLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint){
        ...
        XudenOtherSystemLog mylog = method.getAnnotation(XudenOtherSystemLog.class);
        if(mylog != null){
            //注解上的描述
